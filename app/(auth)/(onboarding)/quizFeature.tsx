  ...
  return (
    <View className="flex-1 bg-amber-50">
      <ScrollView contentContainerStyle={{flexGrow: 1, justifyContent: 'center', alignItems: 'center'}}>
        <Text className="text-4xl font-bold text-lime-900 mx-10 mt-12 mb-5">Quiz Feature</Text>
        ...
        <Image source={require('../../../assets/images/leaderboard_icon.png')} className="w-40 h-36 my-5"></Image>

        <Text className="text-2xl text-center text-lime-900 w-10/12 mx-8 my-5 leading-10">
        Play the quiz daily to earn rewards such as free meal swipes! 
        You can also battle with your friends on the ZotZero Leaderboard!
        </Text>
